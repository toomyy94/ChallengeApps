package challenge.tomas.pt.lastfmchallenge.network;
...
public class MobileNetworkManager {
    ...
    private final LastfmApplication application;

    private MobileNetworkManager(LastfmApplication application) {
     ...
     */
    public synchronized static MobileNetworkManager getInstance(LastfmApplication application) {
        if (instance == null) {
